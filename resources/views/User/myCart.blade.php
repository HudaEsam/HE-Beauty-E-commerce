    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4 product-wap rounded-0">
                ...
                <div class="card-body">
                    <a href="{{url("User.myCart")}}" class="h3 text-decoration-none">{{$product['name']}}</a>
                    ...
                    <li class="list-inline-item">
                        <h6>{{trans("message.Price")}}</h6>
                    </li>
                    <li class="list-inline-item">
                        <p class="text-muted"><strong>{{$product['price']}}</strong></p>
                    </li>
                    <li class="list-inline-item">
                        <h6>{{trans("message.Quantity")}}</h6>
                    </li>
                    <li class="list-inline-item">
                    ...
                    <div class="col d-grid">
                        <button type="submit" class="btn btn-success btn-lg" name="submit" value="addtocard">{{trans("message.Make Order")}}</button>
